...
const postReply = catchAsync(async (req, res) => {
  ...
  const { id }: any = req.user;
  const { content } = req.body;
  const updated = await videoManagementService.addReply(
    videoId,
    commentId,
    id,
    content,
...
const likeVideoComment = catchAsync(async (req, res) => {
  const { videoId, commentId } = req.params;
  const { id }: any = req.user;
  const result = await videoManagementService.likeComment(
    videoId,
    commentId,
    id,
  );
...
const likeVideoReply = catchAsync(async (req, res) => {
  ...
  const { id }: any = req.user;
  const result = await videoManagementService.likeReply(
    videoId,
    commentId,
    replyId,
    id,
...
const unlikeVideoComment = catchAsync(async (req, res) => {
  const { videoId, commentId } = req.params;
  const { id }: any = req.user;
  const result = await videoManagementService.unlikeComment(
    videoId,
    commentId,
    id,
  );
...
const unlikeVideoReply = catchAsync(async (req, res) => {
  ...
  const result = await videoManagementService.unlikeReply(
    videoId,
    commentId,
    replyId,
    id,
...
const removeComment = catchAsync(async (req, res) => {
  const { videoId, commentId } = req.params;
  const { id }: any = req.user;
  const result = await videoManagementService.deleteComment(
    videoId,
    commentId,
    id,
  );
...
const removeReply = catchAsync(async (req, res) => {
  const { videoId, commentId, replyId } = req.params;
  const { id }: any = req.user;
  const result = await videoManagementService.deleteReply(
    videoId,
    commentId,
    replyId,
    id,
